                        ...
                        <div className="space-y-8">
                            ...
                            <section>
                                ...
                                <p className="text-slate-700 leading-relaxed">
                                    Pebble ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Recruitment Customer Relationship Management (CRM) service.
                                </p>
                            ...
                            <section>
                                ...
                                <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                                    ...
                                    <li><strong>Business Data:</strong> Client information, candidate profiles, job details, interaction history, pipeline opportunities</li>
                                </ul>
                            ...
                            <section>
                                ...
                                <p className="text-slate-700 leading-relaxed">
                                    Your data is stored in Google's secure data centres. While we strive to keep data in your preferred region, data may be processed in countries where Google operates data centres. All data processing complies with applicable data protection laws.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                                    <li><strong>Contract:</strong> Processing necessary to provide our Recruitment CRM service</li>
